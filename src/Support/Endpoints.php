...
class Endpoints
{
    ...
    public static function all(): array
    {
        return [
            ...
            self::make('session', 'POST', 'password/reset', [ResetPasswordController::class, 'resetPassword'], 'password.reset', 'Set a new password with the token from the mail.', body: ['token' => 'string', 'email' => 'string', 'password' => 'string', 'password_confirmation' => 'string'], response: 'Message', errors: ['validation_failed', 'reset_failed'], throttle: 'statamic.auth'),
