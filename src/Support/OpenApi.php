    ...
    protected static function schemas(): array
    {
        ...
        return [
            ...
            'BillingSubscription' => $object([
                ...
                'cancelled_at' => $nullableString, 'cancelled_at_display' => $string,
                'ends_at' => ['type' => ['string', 'null'], 'description' => 'When the contract ends or ended, once nothing is charged any more: the end of the paid term, not the day it was cancelled. Null while it runs.'],
                'ended_label' => ['type' => ['string', 'null'], 'description' => '„Gekündigt, läuft bis …" while the paid term runs, „Beendet am <end of term>" after it.'],
            ...
            'CancelResult' => $object([
                ...
                'mail_message' => $nullableString,
                'copied_to' => ['type' => 'array', 'items' => $string, 'description' => 'Further addresses a copy of the confirmation went to (a team\'s billing address).'],
